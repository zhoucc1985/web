...
public class JschUtil {
	 ...
	 *            密码
	 */
	public JschUtil(String host, int port, int timeout, String username, String password) {
		this.host = host;
		this.port = port;
	...
	public Vector<LsEntry> listWithAttrs(String pathName) {
		String currentDir = currentDir();
		if (!changeDir(pathName)) {
			return null;
		}
	 ...
	 * @return boolean
	 */
	public boolean filter(LsEntry entry, Filter f) {
