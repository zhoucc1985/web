 ...
 */
public class CollectionDataVoConvertUtils {
     ...
     */
    public static List<Map<String,CollectionDataErrorObjVO>> convertToErrorListByList(List<CollectionDataSource> sources){
        ...
        sources.forEach(dataSource->{
            ...
            //将错误信息转为错误对象
            List<CollectionDataErrorObjVO> eObjVOs = JSONObject.parseArray(dataSource.getErrorMsg(),CollectionDataErrorObjVO.class);
            //将错误对象按照名称转为map
